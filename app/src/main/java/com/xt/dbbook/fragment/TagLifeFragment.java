...
public class TagLifeFragment extends TagBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
...
//    SwipeRefreshLayout v_refreshLayout;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tag_life, container, false);
